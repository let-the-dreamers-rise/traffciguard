...
- [x] Push the TraffciGuard repository to GitHub
- [x] Create a professional and rich README.md for the TraffciGuard project
- [x] Fix README.md rendering issues on GitHub (e.g. badge links, Mermaid diagram format)
- [x] Replace the projects in the resume (`resume_mlss.tex`) with the user's ML-focused projects:
  - [x] Add TraffciGuard (R² = 0.964)
  - [x] Add ParcelGuard (PyTorch multi-task CNN)
  - [x] Add BidPilot (AI Procurement Automation Platform) with GitHub link
